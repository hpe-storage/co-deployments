...
The HPE COSI Driver for Kubernetes leverages Hewlett Packard Enterprise object storage platforms to provide scalable S3 compatible object storage for workloads running on Kubernetes. Currently supported object storage platforms include HPE Alletra Storage MP X10000 and HPE Alletra Storage MP Disconnected.
...
1. Kubernetes version v1.31 to v1.36
2. OpenShift version v4.19 to v4.21
3. Helm version v3.11 or later
4. HPE Alletra Storage MP X10000 or HPE Alletra Storage MP Disconnected object storage details:
...
**Note:** During an Object Storage Controller upgrade, existing COSI controller resources are not automatically replaced. This may result in duplicate controller `Deployments` and `Pods`. To avoid this, delete any existing controller resources before deploying the new version of the COSI controller.
